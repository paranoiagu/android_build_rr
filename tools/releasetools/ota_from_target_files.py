...
""" % bcb_dev)
  ...
  script.Print(" ")
  script.Print(" ")
  script.Print("   .S_sSSs     .S_sSSs    ")
  script.Print("  .SS~YS%%b   .SS~YS%%b   ")
  script.Print("  S%S   `S%b  S%S   `S%b  ")
  script.Print("  S%S    S%S  S%S    S%S  ")
  script.Print("  S%S    d*S  S%S    d*S  ")
  script.Print("  S&S   .S*S  S&S   .S*S  ")
  script.Print("  S&S_sdSSS   S&S_sdSSS   ")
  script.Print("  S&S~YSY%b   S&S~YSY%b   ")
  script.Print("  S*S   `S%b  S*S   `S%b  ")
  script.Print("  S*S    S%S  S*S    S%S  ")
  script.Print("  S*S    GET  S*S    GOT  ")
  script.Print("  S*S     RR  S*S     RR  ")
  script.Print("  OS       S  OS       S  ")
  script.Print("  X           Y           ")
  script.Print("  Y                       ")
  script.Print("                          ")
  script.Print(" ")
